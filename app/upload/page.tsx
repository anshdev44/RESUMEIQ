            ...
            >
                ...
                >
                    <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "inherit" }}>
                        <div style={{ width: 32, height: 32, backgroundColor: "#000", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <span style={{ color: "#fff", fontWeight: 700, fontSize: 12 }}>IQ</span>
                        </div>
                        <span style={{ fontWeight: 600, fontSize: 18, letterSpacing: "-0.02em" }}>ResumeIQ</span>
                    </Link>
                    <Link
                        href="/"
            ...
            <main style={{ paddingTop: 64, paddingBottom: 96 }}>
                <div style={containerStyle}>
                    ...
                    <div style={{ textAlign: "center", marginBottom: 48 }} className="animate-fade-up">
                        ...
                        <p style={{ color: "#6b7280", marginTop: 12, fontSize: 16, maxWidth: 420, marginLeft: "auto", marginRight: "auto" }}>
                    ...
                    {!uploadResult ? (
                        <div className="animate-fade-up delay-100">
                            ...
                            >
                                ...
                                {!file ? (
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                                        ...
                                        >
                                            <span style={{ color: "#6b7280" }}><FileIcon className="w-6 h-6" /></span>
                                        </div>
                            ...
                            {error && (
                                ...
                                >
                                    <span style={{ flexShrink: 0 }}><XCircleIcon className="w-5 h-5" /></span>
                                    {error}
                                </div>
                            )}
                        ...
                        <div className="animate-fade-up" style={{ textAlign: "center" }}>
                            ...
                            <p style={{ color: "#6b7280", fontSize: 15, marginBottom: 8 }}>
                                <span style={{ fontWeight: 500, color: "#111" }}>{uploadResult.originalName}</span>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 320, marginLeft: "auto", marginRight: "auto" }}>
                                <button
                                    onClick={resetUpload}
                                    style={{
                                        padding: "14px 32px",
